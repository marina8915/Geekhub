    ...
    call: function(method, params, cb, queryTry) {
      ...
      if (useXDM) {
        if (VK.xdReady) {
          ...
          VK.Observer.subscribe('http://userapi.com/js/api/xdm.init', function() {VK.XDM.remote.callMethod('apiCall', method, qs, responseCb);});
          VK.XDM.init();
        }
      } else {
...
if (!VK.Widgets) {
  ...
  VK.Widgets.loading = function(obj, enabled) {
    obj.style.background = enabled ? 'url("upload.gif"/*tpa=http://vk.com/images/upload.gif*/) center center no-repeat transparent' : 'none';
  }
  ...
  VK.Widgets._constructor = function(widgetUrl, objId, options, params, funcs, defaults, onDone, widgetId, iter) {
    ...
    rpc = VK.Widgets.RPC[widgetId] = new fastXDM.Server(funcs, function(origin) {
      ...
      return (origin.indexOf('.vk.com') != -1 || origin.indexOf('http://userapi.com/vk.com') != -1);
    });
